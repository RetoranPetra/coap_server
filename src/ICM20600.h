...
int32_t getRawAccelerationX(uint16_t _acc_scale) {
...
int32_t getRawAccelerationY(uint16_t _acc_scale) {
...
int32_t getRawAccelerationZ(uint16_t _acc_scale) {
...
int16_t getRawGyroscopeX(uint16_t _gyro_scale) {
...
int16_t getRawGyroscopeY(uint16_t _gyro_scale) {
...
int16_t getRawGyroscopeZ(uint16_t _gyro_scale) {
